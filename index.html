		...
		<div class="container">
			<nav class="navbar navbar-default">
				<div class="navbar-header navbar-left">
					...
					<h1><a class="navbar-brand" href="index.php"><p class="logo_w3l_agile_caption">Your Dreamy Resort</p></a></h1>
				</div>
				<!-- Collect the nav links, forms, and other content for toggling -->
				<div class="collapse navbar-collapse navbar-right" id="bs-example-navbar-collapse-1">
					<nav class="menu menu--iris">
						<ul class="nav navbar-nav menu__list">
							<li class="menu__item"><a href="http://localhost:8080/hotelphp/Hotel/admin/index.php">Admin</a></li>
...
<div class="col-md-12 book-form-left-w3layouts">
	<a href="admin/reservation.php"><h2>ROOM RESERVATION</h2></a>
	 ...
	 <!--// rooms & rates -->
			...
			<div class="copy">
		        <p>© 2018. All Rights Reserved | Design by monisha,lohitya,jeya,mohana,varshini,neela</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
